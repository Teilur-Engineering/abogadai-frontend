    ...
    <div className="space-y-4">
      ...
      {fortaleza && (
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          {fortaleza.es_tipo_documento_correcto === false && (
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-yellow-900 mb-1">
                    ⚠️ Sugerencia sobre el tipo de documento
                  </p>
                  <p className="text-sm text-yellow-800 mb-2">
                    Se recomienda usar <strong>{fortaleza.sugerencia_tipo_documento === 'tutela' ? 'TUTELA' : 'DERECHO DE PETICIÓN'}</strong> en lugar de {caso.tipo_documento === 'tutela' ? 'tutela' : 'derecho de petición'}.
                  </p>
                  {fortaleza.razon_sugerencia && (
                    <p className="text-sm text-yellow-700">
                      <strong>Razón:</strong> {fortaleza.razon_sugerencia}
                    </p>
                  )}
                </div>
              </div>
          ...
          {/* Confirmación de Tipo de Documento Correcto */}
          {fortaleza.es_tipo_documento_correcto === true && (
            <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-medium text-green-800">
                  ✓ El tipo de documento seleccionado es apropiado para este caso
                </p>
              </div>
            </div>
          )}
